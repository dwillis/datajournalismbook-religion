...
We can group by city _and_ zip code, like this:
...
We can also calculate the average size of churches in each denomination using the `mean()` function, and add the `median`, too, like this:
